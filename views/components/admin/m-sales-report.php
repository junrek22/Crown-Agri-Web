    ...
    <div class="col-sm-12">
        <div class="panel-heading">
            <div class="panel-title" style="padding-left:0;">
                <h3 style="font-weight:bold; color:#00a651;">Monthly report</h3>   
            </div>
        </div>
    </div>
</div>
...
<script>
  ...
  var char_bar = new Chart(ctx, bar_chart_sales_report_m);
  var char_line = new Chart(ctx3, line_chart_sales_report_m);
</script>
